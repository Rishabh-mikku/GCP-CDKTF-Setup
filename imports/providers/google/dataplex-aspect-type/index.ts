// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type
...
export interface DataplexAspectTypeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#aspect_type_id DataplexAspectType#aspect_type_id}
  */
  readonly aspectTypeId?: string;
  /**
  * Description of the AspectType.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#description DataplexAspectType#description}
  */
  readonly description?: string;
  /**
  * User friendly display name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#display_name DataplexAspectType#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#id DataplexAspectType#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#labels DataplexAspectType#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The location where aspect type will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#location DataplexAspectType#location}
  */
  readonly location?: string;
  /**
  * MetadataTemplate of the Aspect.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#metadata_template DataplexAspectType#metadata_template}
  */
  readonly metadataTemplate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#project DataplexAspectType#project}
  */
  readonly project?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#timeouts DataplexAspectType#timeouts}
  */
  readonly timeouts?: DataplexAspectTypeTimeouts;
}
export interface DataplexAspectTypeTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#create DataplexAspectType#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#delete DataplexAspectType#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#update DataplexAspectType#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type google_dataplex_aspect_type}
*/
export class DataplexAspectType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataplexAspectType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/dataplex_aspect_type google_dataplex_aspect_type} Resource
  *
  * @param scope The scope in which to define this construct
