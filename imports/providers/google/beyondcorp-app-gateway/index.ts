// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway
...
export interface BeyondcorpAppGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#display_name BeyondcorpAppGateway#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#host_type BeyondcorpAppGateway#host_type}
  */
  readonly hostType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#id BeyondcorpAppGateway#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#labels BeyondcorpAppGateway#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * ID of the AppGateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#name BeyondcorpAppGateway#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#project BeyondcorpAppGateway#project}
  */
  readonly project?: string;
  /**
  * The region of the AppGateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#region BeyondcorpAppGateway#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#type BeyondcorpAppGateway#type}
  */
  readonly type?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#timeouts BeyondcorpAppGateway#timeouts}
  */
...
export function beyondcorpAppGatewayAllocatedConnectionsToHclTerraform(struct?: BeyondcorpAppGatewayAllocatedConnections): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface BeyondcorpAppGatewayTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#create BeyondcorpAppGateway#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#delete BeyondcorpAppGateway#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#update BeyondcorpAppGateway#update}
  */
...
export function beyondcorpAppGatewayTimeoutsToHclTerraform(struct?: BeyondcorpAppGatewayTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway google_beyondcorp_app_gateway}
*/
export class BeyondcorpAppGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BeyondcorpAppGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/beyondcorp_app_gateway google_beyondcorp_app_gateway} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: beyondcorpAppGatewayTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "BeyondcorpAppGatewayTimeouts",
      },
    };
