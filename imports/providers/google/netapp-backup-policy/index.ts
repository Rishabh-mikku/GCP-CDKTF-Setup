// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy
...
export interface NetappBackupPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#daily_backup_limit NetappBackupPolicy#daily_backup_limit}
  */
  readonly dailyBackupLimit: number;
  /**
  * An optional description of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#description NetappBackupPolicy#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#enabled NetappBackupPolicy#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#id NetappBackupPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#labels NetappBackupPolicy#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Name of the region for the policy to apply to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#location NetappBackupPolicy#location}
  */
  readonly location: string;
  /**
  * Number of monthly backups to keep. Note that the sum of daily, weekly and monthly backups should be greater than 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#monthly_backup_limit NetappBackupPolicy#monthly_backup_limit}
  */
  readonly monthlyBackupLimit: number;
  /**
  * The name of the backup policy. Needs to be unique per location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#name NetappBackupPolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#project NetappBackupPolicy#project}
  */
  readonly project?: string;
  /**
  * Number of weekly backups to keep. Note that the sum of daily, weekly and monthly backups should be greater than 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#weekly_backup_limit NetappBackupPolicy#weekly_backup_limit}
  */
  readonly weeklyBackupLimit: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#timeouts NetappBackupPolicy#timeouts}
  */
  readonly timeouts?: NetappBackupPolicyTimeouts;
}
export interface NetappBackupPolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#create NetappBackupPolicy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#delete NetappBackupPolicy#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#update NetappBackupPolicy#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy google_netapp_backup_policy}
*/
export class NetappBackupPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetappBackupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_backup_policy google_netapp_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
