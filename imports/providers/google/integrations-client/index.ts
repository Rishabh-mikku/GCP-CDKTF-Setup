// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client
...
export interface IntegrationsClientConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#create_sample_integrations IntegrationsClient#create_sample_integrations}
  */
  readonly createSampleIntegrations?: boolean | cdktf.IResolvable;
  /**
  * Indicates if sample workflow should be created along with provisioning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#create_sample_workflows IntegrationsClient#create_sample_workflows}
  */
  readonly createSampleWorkflows?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#id IntegrationsClient#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#location IntegrationsClient#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#project IntegrationsClient#project}
  */
  readonly project?: string;
  /**
  * Indicates provision with GMEK or CMEK.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#provision_gmek IntegrationsClient#provision_gmek}
  */
  readonly provisionGmek?: boolean | cdktf.IResolvable;
  /**
  * User input run-as service account, if empty, will bring up a new default service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#run_as_service_account IntegrationsClient#run_as_service_account}
  */
  readonly runAsServiceAccount?: string;
  /**
  * cloud_kms_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#cloud_kms_config IntegrationsClient#cloud_kms_config}
  */
  readonly cloudKmsConfig?: IntegrationsClientCloudKmsConfig;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#timeouts IntegrationsClient#timeouts}
  */
...
export interface IntegrationsClientCloudKmsConfig {
  ...
  * specific location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#key IntegrationsClient#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#key_version IntegrationsClient#key_version}
  */
  readonly keyVersion?: string;
  /**
  * Location name of the key ring, e.g. "us-west1".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#kms_location IntegrationsClient#kms_location}
  */
  ...
  * encrypted with GMEK.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#kms_project_id IntegrationsClient#kms_project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#kms_ring IntegrationsClient#kms_ring}
  */
...
export interface IntegrationsClientTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#create IntegrationsClient#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#delete IntegrationsClient#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client google_integrations_client}
*/
export class IntegrationsClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationsClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/integrations_client google_integrations_client} Resource
  *
  * @param scope The scope in which to define this construct
