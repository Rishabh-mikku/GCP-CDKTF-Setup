// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset
...
export interface LoggingLinkedDatasetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#bucket LoggingLinkedDataset#bucket}
  */
  readonly bucket: string;
  /**
  * Describes this link. The maximum length of the description is 8000 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#description LoggingLinkedDataset#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#id LoggingLinkedDataset#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#link_id LoggingLinkedDataset#link_id}
  */
  readonly linkId: string;
  /**
  * The location of the linked dataset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#location LoggingLinkedDataset#location}
  */
  readonly location?: string;
  /**
  * The parent of the linked dataset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#parent LoggingLinkedDataset#parent}
  */
  readonly parent?: string;
  /**
  * bigquery_dataset block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#bigquery_dataset LoggingLinkedDataset#bigquery_dataset}
  */
  readonly bigqueryDataset?: LoggingLinkedDatasetBigqueryDataset[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#timeouts LoggingLinkedDataset#timeouts}
  */
...
export interface LoggingLinkedDatasetTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#create LoggingLinkedDataset#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#delete LoggingLinkedDataset#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset google_logging_linked_dataset}
*/
export class LoggingLinkedDataset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingLinkedDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/logging_linked_dataset google_logging_linked_dataset} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: loggingLinkedDatasetTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "LoggingLinkedDatasetTimeouts",
      },
    };
