// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema
...
export interface DiscoveryEngineSchemaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema#data_store_id DiscoveryEngineSchema#data_store_id}
  */
  readonly dataStoreId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema#id DiscoveryEngineSchema#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema#json_schema DiscoveryEngineSchema#json_schema}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema#location DiscoveryEngineSchema#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema#project DiscoveryEngineSchema#project}
  */
  readonly project?: string;
  /**
  * The unique id of the schema.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema#schema_id DiscoveryEngineSchema#schema_id}
  */
  readonly schemaId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema#timeouts DiscoveryEngineSchema#timeouts}
  */
  readonly timeouts?: DiscoveryEngineSchemaTimeouts;
}
export interface DiscoveryEngineSchemaTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema#create DiscoveryEngineSchema#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema#delete DiscoveryEngineSchema#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema google_discovery_engine_schema}
*/
export class DiscoveryEngineSchema extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DiscoveryEngineSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/discovery_engine_schema google_discovery_engine_schema} Resource
  *
  * @param scope The scope in which to define this construct
