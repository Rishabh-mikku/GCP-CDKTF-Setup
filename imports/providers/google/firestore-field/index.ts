// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field
...
export interface FirestoreFieldConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#collection FirestoreField#collection}
  */
  readonly collection: string;
  /**
  * The Firestore database id. Defaults to '"(default)"'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#database FirestoreField#database}
  */
  readonly database?: string;
  /**
  * The id of the field to configure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#field FirestoreField#field}
  */
  readonly field: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#id FirestoreField#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#project FirestoreField#project}
  */
  readonly project?: string;
  /**
  * index_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#index_config FirestoreField#index_config}
  */
  readonly indexConfig?: FirestoreFieldIndexConfig;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#timeouts FirestoreField#timeouts}
  */
  readonly timeouts?: FirestoreFieldTimeouts;
  /**
  * ttl_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#ttl_config FirestoreField#ttl_config}
  */
...
export interface FirestoreFieldIndexConfigIndexes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#array_config FirestoreField#array_config}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#order FirestoreField#order}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#query_scope FirestoreField#query_scope}
  */
...
export interface FirestoreFieldIndexConfig {
  ...
  * indexes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#indexes FirestoreField#indexes}
  */
...
export interface FirestoreFieldTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#create FirestoreField#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#delete FirestoreField#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#update FirestoreField#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field google_firestore_field}
*/
export class FirestoreField extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirestoreField that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/firestore_field google_firestore_field} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      index_config: {
        value: firestoreFieldIndexConfigToHclTerraform(this._indexConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "FirestoreFieldIndexConfigList",
      },
      timeouts: {
        value: firestoreFieldTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "FirestoreFieldTimeouts",
      },
      ttl_config: {
        value: firestoreFieldTtlConfigToHclTerraform(this._ttlConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "FirestoreFieldTtlConfigList",
      },
    };
