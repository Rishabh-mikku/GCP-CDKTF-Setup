// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info
...
export interface BillingProjectInfoConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info#billing_account BillingProjectInfo#billing_account}
  */
  readonly billingAccount: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info#id BillingProjectInfo#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info#project BillingProjectInfo#project}
  */
  readonly project?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info#timeouts BillingProjectInfo#timeouts}
  */
  readonly timeouts?: BillingProjectInfoTimeouts;
}
export interface BillingProjectInfoTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info#create BillingProjectInfo#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info#delete BillingProjectInfo#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info#update BillingProjectInfo#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info google_billing_project_info}
*/
export class BillingProjectInfo extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BillingProjectInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/billing_project_info google_billing_project_info} Resource
  *
  * @param scope The scope in which to define this construct
