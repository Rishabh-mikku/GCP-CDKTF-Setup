// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster
...
export interface ContainerAzureClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#annotations ContainerAzureCluster#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * The Azure region where the cluster runs. Each Google Cloud region supports a subset of nearby Azure regions. You can call to list all supported Azure regions within a given Google Cloud region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#azure_region ContainerAzureCluster#azure_region}
  */
  readonly azureRegion: string;
  /**
  * Name of the AzureClient. The `AzureClient` resource must reside on the same GCP project and region as the `AzureCluster`. `AzureClient` names are formatted as `projects/<project-number>/locations/<region>/azureClients/<client-id>`. See Resource Names (https:cloud.google.com/apis/design/resource_names) for more details on Google Cloud resource names.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#client ContainerAzureCluster#client}
  */
  readonly client?: string;
  /**
  * Optional. A human readable description of this cluster. Cannot be longer than 255 UTF-8 encoded bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#description ContainerAzureCluster#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#id ContainerAzureCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#location ContainerAzureCluster#location}
  */
  readonly location: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#name ContainerAzureCluster#name}
  */
  readonly name: string;
  /**
  * The project for the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#project ContainerAzureCluster#project}
  */
  readonly project?: string;
  /**
  * The ARM ID of the resource group where the cluster resources are deployed. For example: `/subscriptions/* /resourceGroups/*`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#resource_group_id ContainerAzureCluster#resource_group_id}
   *
  ...
  * authorization block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#authorization ContainerAzureCluster#authorization}
  */
  readonly authorization: ContainerAzureClusterAuthorization;
  /**
  * azure_services_authentication block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#azure_services_authentication ContainerAzureCluster#azure_services_authentication}
  */
  readonly azureServicesAuthentication?: ContainerAzureClusterAzureServicesAuthentication;
  /**
  * control_plane block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#control_plane ContainerAzureCluster#control_plane}
  */
  readonly controlPlane: ContainerAzureClusterControlPlane;
  /**
  * fleet block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#fleet ContainerAzureCluster#fleet}
  */
  readonly fleet: ContainerAzureClusterFleet;
  /**
  * networking block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#networking ContainerAzureCluster#networking}
  */
  readonly networking: ContainerAzureClusterNetworking;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#timeouts ContainerAzureCluster#timeouts}
  */
...
export function containerAzureClusterWorkloadIdentityConfigToHclTerraform(struct?: ContainerAzureClusterWorkloadIdentityConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface ContainerAzureClusterAuthorizationAdminGroups {
  /**
  * The name of the group, e.g. `my-group@domain.com`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#group ContainerAzureCluster#group}
  */
  readonly group: string;
}

export function containerAzureClusterAuthorizationAdminGroupsToTerraform(struct?: ContainerAzureClusterAuthorizationAdminGroups | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function containerAzureClusterAuthorizationAdminGroupsToHclTerraform(struct?: ContainerAzureClusterAuthorizationAdminGroups | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ContainerAzureClusterAuthorizationAdminGroupsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ContainerAzureClusterAuthorizationAdminGroups | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ContainerAzureClusterAuthorizationAdminGroups | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class ContainerAzureClusterAuthorizationAdminGroupsList extends cdktf.ComplexList {
  public internalValue? : ContainerAzureClusterAuthorizationAdminGroups[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ContainerAzureClusterAuthorizationAdminGroupsOutputReference {
    return new ContainerAzureClusterAuthorizationAdminGroupsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ContainerAzureClusterAuthorizationAdminUsers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#username ContainerAzureCluster#username}
  */
...
export function containerAzureClusterAuthorizationAdminUsersToHclTerraform(struct?: ContainerAzureClusterAuthorizationAdminUsers | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface ContainerAzureClusterAuthorization {
  ...
  * admin_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#admin_groups ContainerAzureCluster#admin_groups}
  */
  readonly adminGroups?: ContainerAzureClusterAuthorizationAdminGroups[] | cdktf.IResolvable;
  /**
  * admin_users block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#admin_users ContainerAzureCluster#admin_users}
  */
...
export function containerAzureClusterAuthorizationToTerraform(struct?: ContainerAzureClusterAuthorizationOutputReference | ContainerAzureClusterAuthorization): any {
  ...
  return {
    admin_groups: cdktf.listMapper(containerAzureClusterAuthorizationAdminGroupsToTerraform, true)(struct!.adminGroups),
    admin_users: cdktf.listMapper(containerAzureClusterAuthorizationAdminUsersToTerraform, true)(struct!.adminUsers),
  }
}


export function containerAzureClusterAuthorizationToHclTerraform(struct?: ContainerAzureClusterAuthorizationOutputReference | ContainerAzureClusterAuthorization): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    admin_groups: {
      value: cdktf.listMapperHcl(containerAzureClusterAuthorizationAdminGroupsToHclTerraform, true)(struct!.adminGroups),
      isBlock: true,
      type: "list",
      storageClassType: "ContainerAzureClusterAuthorizationAdminGroupsList",
    },
    admin_users: {
      value: cdktf.listMapperHcl(containerAzureClusterAuthorizationAdminUsersToHclTerraform, true)(struct!.adminUsers),
      isBlock: true,
      type: "list",
      storageClassType: "ContainerAzureClusterAuthorizationAdminUsersList",
    },
  };
...
export class ContainerAzureClusterAuthorizationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _adminGroups = new ContainerAzureClusterAuthorizationAdminGroupsList(this, "admin_groups", false);
  public get adminGroups() {
    return this._adminGroups;
  }
  public putAdminGroups(value: ContainerAzureClusterAuthorizationAdminGroups[] | cdktf.IResolvable) {
...
export interface ContainerAzureClusterAzureServicesAuthentication {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#application_id ContainerAzureCluster#application_id}
  */
  readonly applicationId: string;
  /**
  * The Azure Active Directory Tenant ID for Authentication configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#tenant_id ContainerAzureCluster#tenant_id}
  */
  readonly tenantId: string;
}

export function containerAzureClusterAzureServicesAuthenticationToTerraform(struct?: ContainerAzureClusterAzureServicesAuthenticationOutputReference | ContainerAzureClusterAzureServicesAuthentication): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function containerAzureClusterAzureServicesAuthenticationToHclTerraform(struct?: ContainerAzureClusterAzureServicesAuthenticationOutputReference | ContainerAzureClusterAzureServicesAuthentication): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ContainerAzureClusterAzureServicesAuthenticationOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ContainerAzureClusterAzureServicesAuthentication | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: ContainerAzureClusterAzureServicesAuthentication | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface ContainerAzureClusterControlPlaneDatabaseEncryption {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#key_id ContainerAzureCluster#key_id}
  */
...
export function containerAzureClusterControlPlaneDatabaseEncryptionToHclTerraform(struct?: ContainerAzureClusterControlPlaneDatabaseEncryptionOutputReference | ContainerAzureClusterControlPlaneDatabaseEncryption): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface ContainerAzureClusterControlPlaneMainVolume {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#size_gib ContainerAzureCluster#size_gib}
  */
...
export function containerAzureClusterControlPlaneMainVolumeToHclTerraform(struct?: ContainerAzureClusterControlPlaneMainVolumeOutputReference | ContainerAzureClusterControlPlaneMainVolume): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface ContainerAzureClusterControlPlaneProxyConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#secret_id ContainerAzureCluster#secret_id}
  */
...
export function containerAzureClusterControlPlaneProxyConfigToHclTerraform(struct?: ContainerAzureClusterControlPlaneProxyConfigOutputReference | ContainerAzureClusterControlPlaneProxyConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface ContainerAzureClusterControlPlaneReplicaPlacements {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#azure_availability_zone ContainerAzureCluster#azure_availability_zone}
  */
  readonly azureAvailabilityZone: string;
  /**
  * For a given replica, the ARM ID of the subnet where the control plane VM is deployed. Make sure it's a subnet under the virtual network in the cluster configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#subnet_id ContainerAzureCluster#subnet_id}
  */
...
export function containerAzureClusterControlPlaneReplicaPlacementsToHclTerraform(struct?: ContainerAzureClusterControlPlaneReplicaPlacements | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function containerAzureClusterControlPlaneRootVolumeToHclTerraform(struct?: ContainerAzureClusterControlPlaneRootVolumeOutputReference | ContainerAzureClusterControlPlaneRootVolume): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface ContainerAzureClusterControlPlaneSshConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#authorized_key ContainerAzureCluster#authorized_key}
  */
...
export function containerAzureClusterControlPlaneSshConfigToHclTerraform(struct?: ContainerAzureClusterControlPlaneSshConfigOutputReference | ContainerAzureClusterControlPlaneSshConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface ContainerAzureClusterControlPlane {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#tags ContainerAzureCluster#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The Kubernetes version to run on control plane replicas (e.g. `1.19.10-gke.1000`). You can list all supported versions on a given Google Cloud region by calling GetAzureServerConfig.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#version ContainerAzureCluster#version}
  */
  readonly version: string;
  /**
  * Optional. The Azure VM size name. Example: `Standard_DS2_v2`. For available VM sizes, see https://docs.microsoft.com/en-us/azure/virtual-machines/vm-naming-conventions. When unspecified, it defaults to `Standard_DS2_v2`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#vm_size ContainerAzureCluster#vm_size}
  */
  readonly vmSize?: string;
  /**
  * database_encryption block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#database_encryption ContainerAzureCluster#database_encryption}
  */
  readonly databaseEncryption?: ContainerAzureClusterControlPlaneDatabaseEncryption;
  /**
  * main_volume block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#main_volume ContainerAzureCluster#main_volume}
  */
  readonly mainVolume?: ContainerAzureClusterControlPlaneMainVolume;
  /**
  * proxy_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#proxy_config ContainerAzureCluster#proxy_config}
  */
  readonly proxyConfig?: ContainerAzureClusterControlPlaneProxyConfig;
  /**
  * replica_placements block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#replica_placements ContainerAzureCluster#replica_placements}
  */
  readonly replicaPlacements?: ContainerAzureClusterControlPlaneReplicaPlacements[] | cdktf.IResolvable;
  /**
  * root_volume block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#root_volume ContainerAzureCluster#root_volume}
  */
  readonly rootVolume?: ContainerAzureClusterControlPlaneRootVolume;
  /**
  * ssh_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#ssh_config ContainerAzureCluster#ssh_config}
  */
...
export function containerAzureClusterControlPlaneToHclTerraform(struct?: ContainerAzureClusterControlPlaneOutputReference | ContainerAzureClusterControlPlane): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    database_encryption: {
      value: containerAzureClusterControlPlaneDatabaseEncryptionToHclTerraform(struct!.databaseEncryption),
      isBlock: true,
      type: "list",
      storageClassType: "ContainerAzureClusterControlPlaneDatabaseEncryptionList",
    },
    main_volume: {
      value: containerAzureClusterControlPlaneMainVolumeToHclTerraform(struct!.mainVolume),
      isBlock: true,
      type: "list",
      storageClassType: "ContainerAzureClusterControlPlaneMainVolumeList",
    },
    proxy_config: {
      value: containerAzureClusterControlPlaneProxyConfigToHclTerraform(struct!.proxyConfig),
      isBlock: true,
      type: "list",
      storageClassType: "ContainerAzureClusterControlPlaneProxyConfigList",
    },
    replica_placements: {
      value: cdktf.listMapperHcl(containerAzureClusterControlPlaneReplicaPlacementsToHclTerraform, true)(struct!.replicaPlacements),
      isBlock: true,
      type: "list",
      storageClassType: "ContainerAzureClusterControlPlaneReplicaPlacementsList",
    },
    root_volume: {
      value: containerAzureClusterControlPlaneRootVolumeToHclTerraform(struct!.rootVolume),
      isBlock: true,
      type: "list",
      storageClassType: "ContainerAzureClusterControlPlaneRootVolumeList",
    },
    ssh_config: {
      value: containerAzureClusterControlPlaneSshConfigToHclTerraform(struct!.sshConfig),
      isBlock: true,
      type: "list",
      storageClassType: "ContainerAzureClusterControlPlaneSshConfigList",
    },
  };
...
export function containerAzureClusterFleetToHclTerraform(struct?: ContainerAzureClusterFleetOutputReference | ContainerAzureClusterFleet): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface ContainerAzureClusterNetworking {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#pod_address_cidr_blocks ContainerAzureCluster#pod_address_cidr_blocks}
  */
  readonly podAddressCidrBlocks: string[];
  /**
  * The IP address range for services in this cluster, in CIDR notation (e.g. `10.96.0.0/14`). All services in the cluster get assigned a unique RFC1918 IPv4 address from these ranges. Only a single range is supported. This field cannot be changed after creating a cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#service_address_cidr_blocks ContainerAzureCluster#service_address_cidr_blocks}
  */
  readonly serviceAddressCidrBlocks: string[];
  /**
  * The Azure Resource Manager (ARM) ID of the VNet associated with your cluster. All components in the cluster (i.e. control plane and node pools) run on a single VNet. Example: `/subscriptions/* /resourceGroups/* /providers/Microsoft.Network/virtualNetworks/*` This field cannot be changed after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#virtual_network_id ContainerAzureCluster#virtual_network_id}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
...
export function containerAzureClusterNetworkingToHclTerraform(struct?: ContainerAzureClusterNetworkingOutputReference | ContainerAzureClusterNetworking): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface ContainerAzureClusterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#create ContainerAzureCluster#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#delete ContainerAzureCluster#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#update ContainerAzureCluster#update}
  */
  readonly update?: string;
}

export function containerAzureClusterTimeoutsToTerraform(struct?: ContainerAzureClusterTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function containerAzureClusterTimeoutsToHclTerraform(struct?: ContainerAzureClusterTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster google_container_azure_cluster}
*/
export class ContainerAzureCluster extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the ContainerAzureCluster to import
  * @param importFromId The id of the existing ContainerAzureCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/container_azure_cluster google_container_azure_cluster} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _azureServicesAuthentication = new ContainerAzureClusterAzureServicesAuthenticationOutputReference(this, "azure_services_authentication");
  public get azureServicesAuthentication() {
    return this._azureServicesAuthentication;
  }
  public putAzureServicesAuthentication(value: ContainerAzureClusterAzureServicesAuthentication) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      azure_services_authentication: containerAzureClusterAzureServicesAuthenticationToTerraform(this._azureServicesAuthentication.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      authorization: {
        value: containerAzureClusterAuthorizationToHclTerraform(this._authorization.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ContainerAzureClusterAuthorizationList",
      },
      azure_services_authentication: {
        value: containerAzureClusterAzureServicesAuthenticationToHclTerraform(this._azureServicesAuthentication.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ContainerAzureClusterAzureServicesAuthenticationList",
      },
      control_plane: {
        value: containerAzureClusterControlPlaneToHclTerraform(this._controlPlane.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ContainerAzureClusterControlPlaneList",
      },
      fleet: {
        value: containerAzureClusterFleetToHclTerraform(this._fleet.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ContainerAzureClusterFleetList",
      },
      networking: {
        value: containerAzureClusterNetworkingToHclTerraform(this._networking.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ContainerAzureClusterNetworkingList",
      },
      timeouts: {
        value: containerAzureClusterTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ContainerAzureClusterTimeouts",
      },
    };
