// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool
...
export interface NetappStoragePoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#active_directory NetappStoragePool#active_directory}
  */
  readonly activeDirectory?: string;
  /**
  * Capacity of the storage pool (in GiB).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#capacity_gib NetappStoragePool#capacity_gib}
  */
  readonly capacityGib: string;
  /**
  * An optional description of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#description NetappStoragePool#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#id NetappStoragePool#id}
  *
  ...
  * The policy needs to be in the same location as the storage pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#kms_config NetappStoragePool#kms_config}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#labels NetappStoragePool#labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#ldap_enabled NetappStoragePool#ldap_enabled}
  */
  readonly ldapEnabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the location. For zonal Flex pools specify a zone name, in all other cases a region name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#location NetappStoragePool#location}
  */
  readonly location: string;
  /**
  * The resource name of the storage pool. Needs to be unique per location/region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#name NetappStoragePool#name}
  */
  readonly name: string;
  /**
  * VPC network name with format: 'projects/{{project}}/global/networks/{{network}}'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#network NetappStoragePool#network}
  */
  readonly network: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#project NetappStoragePool#project}
  */
  readonly project?: string;
  /**
  * Service level of the storage pool. Possible values: ["PREMIUM", "EXTREME", "STANDARD", "FLEX"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#service_level NetappStoragePool#service_level}
  */
  readonly serviceLevel: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#timeouts NetappStoragePool#timeouts}
  */
  readonly timeouts?: NetappStoragePoolTimeouts;
}
export interface NetappStoragePoolTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#create NetappStoragePool#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#delete NetappStoragePool#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#update NetappStoragePool#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool google_netapp_storage_pool}
*/
export class NetappStoragePool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetappStoragePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/netapp_storage_pool google_netapp_storage_pool} Resource
  *
  * @param scope The scope in which to define this construct
