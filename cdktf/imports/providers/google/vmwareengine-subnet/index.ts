// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet
...
export interface VmwareengineSubnetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet#id VmwareengineSubnet#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet#ip_cidr_range VmwareengineSubnet#ip_cidr_range}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet#name VmwareengineSubnet#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet#parent VmwareengineSubnet#parent}
  */
  readonly parent: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet#timeouts VmwareengineSubnet#timeouts}
  */
...
export class VmwareengineSubnetDhcpAddressRangesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): VmwareengineSubnetDhcpAddressRanges | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: VmwareengineSubnetDhcpAddressRanges | undefined) {
    if (value === undefined) {
...
export class VmwareengineSubnetDhcpAddressRangesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): VmwareengineSubnetDhcpAddressRangesOutputReference {
    return new VmwareengineSubnetDhcpAddressRangesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface VmwareengineSubnetTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet#create VmwareengineSubnet#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet#delete VmwareengineSubnet#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet#update VmwareengineSubnet#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet google_vmwareengine_subnet}
*/
export class VmwareengineSubnet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VmwareengineSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/vmwareengine_subnet google_vmwareengine_subnet} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options VmwareengineSubnetConfig
  */
  public constructor(scope: Construct, id: string, config: VmwareengineSubnetConfig) {
    super(scope, id, {
  ...
  private _dhcpAddressRanges = new VmwareengineSubnetDhcpAddressRangesList(this, "dhcp_address_ranges", false);
  ...
  private _timeouts = new VmwareengineSubnetTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: VmwareengineSubnetTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: vmwareengineSubnetTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "VmwareengineSubnetTimeouts",
      },
    };
