// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server
...
export interface ApigeeTargetServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#description ApigeeTargetServer#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#env_id ApigeeTargetServer#env_id}
  */
  readonly envId: string;
  /**
  * The host name this target connects to. Value must be a valid hostname as described by RFC-1123.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#host ApigeeTargetServer#host}
  */
  readonly host: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#id ApigeeTargetServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#is_enabled ApigeeTargetServer#is_enabled}
  */
  readonly isEnabled?: boolean | cdktf.IResolvable;
  /**
  * The resource id of this reference. Values must match the regular expression [\w\s-.]+.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#name ApigeeTargetServer#name}
  */
  readonly name: string;
  /**
  * The port number this target connects to on the given host. Value must be between 1 and 65535, inclusive.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#port ApigeeTargetServer#port}
  */
  readonly port: number;
  /**
  * Immutable. The protocol used by this TargetServer. Possible values: ["HTTP", "HTTP2", "GRPC_TARGET", "GRPC", "EXTERNAL_CALLOUT"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#protocol ApigeeTargetServer#protocol}
  */
  readonly protocol?: string;
  /**
  * s_sl_info block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#s_sl_info ApigeeTargetServer#s_sl_info}
  */
  readonly sSlInfo?: ApigeeTargetServerSSlInfo;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#timeouts ApigeeTargetServer#timeouts}
  */
...
export interface ApigeeTargetServerSSlInfoCommonName {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#value ApigeeTargetServer#value}
  */
  readonly value?: string;
  /**
  * Indicates whether the cert should be matched against as a wildcard cert.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#wildcard_match ApigeeTargetServer#wildcard_match}
  */
...
export interface ApigeeTargetServerSSlInfo {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#ciphers ApigeeTargetServer#ciphers}
  */
  readonly ciphers?: string[];
  /**
  * Enables two-way TLS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#client_auth_enabled ApigeeTargetServer#client_auth_enabled}
  */
  readonly clientAuthEnabled?: boolean | cdktf.IResolvable;
  /**
  * Enables TLS. If false, neither one-way nor two-way TLS will be enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#enabled ApigeeTargetServer#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * If true, Edge ignores TLS certificate errors. Valid when configuring TLS for target servers and target endpoints, and when configuring virtual hosts that use 2-way TLS. When used with a target endpoint/target server, if the backend system uses SNI and returns a cert with a subject Distinguished Name (DN) that does not match the hostname, there is no way to ignore the error and the connection fails.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#ignore_validation_errors ApigeeTargetServer#ignore_validation_errors}
  */
  readonly ignoreValidationErrors?: boolean | cdktf.IResolvable;
  /**
  * Required if clientAuthEnabled is true. The resource ID for the alias containing the private key and cert.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#key_alias ApigeeTargetServer#key_alias}
  */
  readonly keyAlias?: string;
  /**
  * Required if clientAuthEnabled is true. The resource ID of the keystore.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#key_store ApigeeTargetServer#key_store}
  */
  readonly keyStore?: string;
  /**
  * The TLS versioins to be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#protocols ApigeeTargetServer#protocols}
  */
  readonly protocols?: string[];
  /**
  * The resource ID of the truststore.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#trust_store ApigeeTargetServer#trust_store}
  */
  readonly trustStore?: string;
  /**
  * common_name block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#common_name ApigeeTargetServer#common_name}
  */
...
export interface ApigeeTargetServerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#create ApigeeTargetServer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#delete ApigeeTargetServer#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#update ApigeeTargetServer#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server google_apigee_target_server}
*/
export class ApigeeTargetServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeTargetServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/apigee_target_server google_apigee_target_server} Resource
  *
  * @param scope The scope in which to define this construct
