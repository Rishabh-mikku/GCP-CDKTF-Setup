// https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function
...
export interface Cloudfunctions2FunctionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#description Cloudfunctions2Function#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#id Cloudfunctions2Function#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#kms_key_name Cloudfunctions2Function#kms_key_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#labels Cloudfunctions2Function#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The location of this cloud function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#location Cloudfunctions2Function#location}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#name Cloudfunctions2Function#name}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#project Cloudfunctions2Function#project}
  */
  readonly project?: string;
  /**
  * build_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#build_config Cloudfunctions2Function#build_config}
  */
  readonly buildConfig?: Cloudfunctions2FunctionBuildConfig;
  /**
  * event_trigger block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#event_trigger Cloudfunctions2Function#event_trigger}
  */
  readonly eventTrigger?: Cloudfunctions2FunctionEventTrigger;
  /**
  * service_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#service_config Cloudfunctions2Function#service_config}
  */
  readonly serviceConfig?: Cloudfunctions2FunctionServiceConfig;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#timeouts Cloudfunctions2Function#timeouts}
  */
...
export function cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicyToTerraform(struct?: Cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicyOutputReference | Cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicy): any {
...
export function cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicyToHclTerraform(struct?: Cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicyOutputReference | Cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicy): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: Cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicy | undefined) {
    if (value === undefined) {
...
export function cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicyToTerraform(struct?: Cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicyOutputReference | Cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicy): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicyToHclTerraform(struct?: Cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicyOutputReference | Cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicy): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicyOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): Cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: Cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicy | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export interface Cloudfunctions2FunctionBuildConfigSourceRepoSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#branch_name Cloudfunctions2Function#branch_name}
  */
  readonly branchName?: string;
  /**
  * Regex matching tags to build.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#commit_sha Cloudfunctions2Function#commit_sha}
  */
  readonly commitSha?: string;
  /**
  * Directory, relative to the source root, in which to run the build.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#dir Cloudfunctions2Function#dir}
  */
  readonly dir?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#invert_regex Cloudfunctions2Function#invert_regex}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#project_id Cloudfunctions2Function#project_id}
  */
  readonly projectId?: string;
  /**
  * Name of the Cloud Source Repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#repo_name Cloudfunctions2Function#repo_name}
  */
  readonly repoName?: string;
  /**
  * Regex matching tags to build.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#tag_name Cloudfunctions2Function#tag_name}
  */
...
export function cloudfunctions2FunctionBuildConfigSourceRepoSourceToHclTerraform(struct?: Cloudfunctions2FunctionBuildConfigSourceRepoSourceOutputReference | Cloudfunctions2FunctionBuildConfigSourceRepoSource): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface Cloudfunctions2FunctionBuildConfigSourceStorageSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#bucket Cloudfunctions2Function#bucket}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#generation Cloudfunctions2Function#generation}
  */
  readonly generation?: number;
  /**
  * Google Cloud Storage object containing the source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#object Cloudfunctions2Function#object}
  */
...
export function cloudfunctions2FunctionBuildConfigSourceStorageSourceToHclTerraform(struct?: Cloudfunctions2FunctionBuildConfigSourceStorageSourceOutputReference | Cloudfunctions2FunctionBuildConfigSourceStorageSource): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface Cloudfunctions2FunctionBuildConfigSource {
  ...
  * repo_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#repo_source Cloudfunctions2Function#repo_source}
  */
  readonly repoSource?: Cloudfunctions2FunctionBuildConfigSourceRepoSource;
  /**
  * storage_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#storage_source Cloudfunctions2Function#storage_source}
  */
...
export function cloudfunctions2FunctionBuildConfigSourceToHclTerraform(struct?: Cloudfunctions2FunctionBuildConfigSourceOutputReference | Cloudfunctions2FunctionBuildConfigSource): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface Cloudfunctions2FunctionBuildConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#docker_repository Cloudfunctions2Function#docker_repository}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#entry_point Cloudfunctions2Function#entry_point}
  */
  readonly entryPoint?: string;
  /**
  * User-provided build-time environment variables for the function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#environment_variables Cloudfunctions2Function#environment_variables}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#runtime Cloudfunctions2Function#runtime}
  */
  readonly runtime?: string;
  /**
  * The fully-qualified name of the service account to be used for building the container.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#service_account Cloudfunctions2Function#service_account}
  */
  readonly serviceAccount?: string;
  /**
  * Name of the Cloud Build Custom Worker Pool that should be used to build the function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#worker_pool Cloudfunctions2Function#worker_pool}
  */
  readonly workerPool?: string;
  /**
  * automatic_update_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#automatic_update_policy Cloudfunctions2Function#automatic_update_policy}
  */
  readonly automaticUpdatePolicy?: Cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicy;
  /**
  * on_deploy_update_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#on_deploy_update_policy Cloudfunctions2Function#on_deploy_update_policy}
  */
  readonly onDeployUpdatePolicy?: Cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicy;
  /**
  * source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#source Cloudfunctions2Function#source}
  */
...
export function cloudfunctions2FunctionBuildConfigToHclTerraform(struct?: Cloudfunctions2FunctionBuildConfigOutputReference | Cloudfunctions2FunctionBuildConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Cloudfunctions2FunctionBuildConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _automaticUpdatePolicy = new Cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicyOutputReference(this, "automatic_update_policy");
  public get automaticUpdatePolicy() {
    return this._automaticUpdatePolicy;
  }
  public putAutomaticUpdatePolicy(value: Cloudfunctions2FunctionBuildConfigAutomaticUpdatePolicy) {
  ...
  private _onDeployUpdatePolicy = new Cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicyOutputReference(this, "on_deploy_update_policy");
  public get onDeployUpdatePolicy() {
    return this._onDeployUpdatePolicy;
  }
  public putOnDeployUpdatePolicy(value: Cloudfunctions2FunctionBuildConfigOnDeployUpdatePolicy) {
...
export interface Cloudfunctions2FunctionEventTriggerEventFilters {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#attribute Cloudfunctions2Function#attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#operator Cloudfunctions2Function#operator}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#value Cloudfunctions2Function#value}
  */
...
export function cloudfunctions2FunctionEventTriggerEventFiltersToHclTerraform(struct?: Cloudfunctions2FunctionEventTriggerEventFilters | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface Cloudfunctions2FunctionEventTrigger {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#event_type Cloudfunctions2Function#event_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#pubsub_topic Cloudfunctions2Function#pubsub_topic}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#retry_policy Cloudfunctions2Function#retry_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#service_account_email Cloudfunctions2Function#service_account_email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#trigger_region Cloudfunctions2Function#trigger_region}
  */
  readonly triggerRegion?: string;
  /**
  * event_filters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#event_filters Cloudfunctions2Function#event_filters}
  */
...
export function cloudfunctions2FunctionEventTriggerToHclTerraform(struct?: Cloudfunctions2FunctionEventTriggerOutputReference | Cloudfunctions2FunctionEventTrigger): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface Cloudfunctions2FunctionServiceConfigSecretEnvironmentVariables {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#key Cloudfunctions2Function#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#secret Cloudfunctions2Function#secret}
  */
  readonly secret: string;
  /**
  * Version of the secret (version number or the string 'latest'). It is recommended to use a numeric version for secret environment variables as any updates to the secret value is not reflected until new instances start.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#version Cloudfunctions2Function#version}
  */
...
export function cloudfunctions2FunctionServiceConfigSecretEnvironmentVariablesToHclTerraform(struct?: Cloudfunctions2FunctionServiceConfigSecretEnvironmentVariables | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface Cloudfunctions2FunctionServiceConfigSecretVolumesVersions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#path Cloudfunctions2Function#path}
  */
...
export function cloudfunctions2FunctionServiceConfigSecretVolumesVersionsToHclTerraform(struct?: Cloudfunctions2FunctionServiceConfigSecretVolumesVersions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface Cloudfunctions2FunctionServiceConfigSecretVolumes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#mount_path Cloudfunctions2Function#mount_path}
  */
  ...
  * versions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#versions Cloudfunctions2Function#versions}
  */
...
export function cloudfunctions2FunctionServiceConfigSecretVolumesToHclTerraform(struct?: Cloudfunctions2FunctionServiceConfigSecretVolumes | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    versions: {
      value: cdktf.listMapperHcl(cloudfunctions2FunctionServiceConfigSecretVolumesVersionsToHclTerraform, true)(struct!.versions),
      isBlock: true,
      type: "list",
      storageClassType: "Cloudfunctions2FunctionServiceConfigSecretVolumesVersionsList",
    },
  };
...
export interface Cloudfunctions2FunctionServiceConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#all_traffic_on_latest_revision Cloudfunctions2Function#all_traffic_on_latest_revision}
  */
  readonly allTrafficOnLatestRevision?: boolean | cdktf.IResolvable;
  /**
  * The number of CPUs used in a single container instance. Default value is calculated from available memory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#available_cpu Cloudfunctions2Function#available_cpu}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#available_memory Cloudfunctions2Function#available_memory}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#ingress_settings Cloudfunctions2Function#ingress_settings}
  */
  ...
  * given time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#max_instance_count Cloudfunctions2Function#max_instance_count}
  */
  readonly maxInstanceCount?: number;
  /**
  * Sets the maximum number of concurrent requests that each instance can receive. Defaults to 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#max_instance_request_concurrency Cloudfunctions2Function#max_instance_request_concurrency}
  */
  ...
  * given time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#min_instance_count Cloudfunctions2Function#min_instance_count}
  */
  readonly minInstanceCount?: number;
  /**
  * Name of the service associated with a Function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#service Cloudfunctions2Function#service}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#timeout_seconds Cloudfunctions2Function#timeout_seconds}
  */
  readonly timeoutSeconds?: number;
  /**
  * The Serverless VPC Access connector that this cloud function can connect to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#vpc_connector Cloudfunctions2Function#vpc_connector}
  */
  readonly vpcConnector?: string;
  /**
  * Available egress settings. Possible values: ["VPC_CONNECTOR_EGRESS_SETTINGS_UNSPECIFIED", "PRIVATE_RANGES_ONLY", "ALL_TRAFFIC"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#vpc_connector_egress_settings Cloudfunctions2Function#vpc_connector_egress_settings}
  */
  readonly vpcConnectorEgressSettings?: string;
  /**
  * secret_environment_variables block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#secret_environment_variables Cloudfunctions2Function#secret_environment_variables}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#secret_volumes Cloudfunctions2Function#secret_volumes}
  */
...
export function cloudfunctions2FunctionServiceConfigToHclTerraform(struct?: Cloudfunctions2FunctionServiceConfigOutputReference | Cloudfunctions2FunctionServiceConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    secret_environment_variables: {
      value: cdktf.listMapperHcl(cloudfunctions2FunctionServiceConfigSecretEnvironmentVariablesToHclTerraform, true)(struct!.secretEnvironmentVariables),
      isBlock: true,
      type: "list",
      storageClassType: "Cloudfunctions2FunctionServiceConfigSecretEnvironmentVariablesList",
    },
    secret_volumes: {
      value: cdktf.listMapperHcl(cloudfunctions2FunctionServiceConfigSecretVolumesToHclTerraform, true)(struct!.secretVolumes),
      isBlock: true,
      type: "list",
      storageClassType: "Cloudfunctions2FunctionServiceConfigSecretVolumesList",
    },
  };
...
export interface Cloudfunctions2FunctionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#create Cloudfunctions2Function#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#delete Cloudfunctions2Function#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#update Cloudfunctions2Function#update}
  */
  readonly update?: string;
}

export function cloudfunctions2FunctionTimeoutsToTerraform(struct?: Cloudfunctions2FunctionTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function cloudfunctions2FunctionTimeoutsToHclTerraform(struct?: Cloudfunctions2FunctionTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function google_cloudfunctions2_function}
*/
export class Cloudfunctions2Function extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the Cloudfunctions2Function to import
  * @param importFromId The id of the existing Cloudfunctions2Function that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.2/docs/resources/cloudfunctions2_function google_cloudfunctions2_function} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      build_config: {
        value: cloudfunctions2FunctionBuildConfigToHclTerraform(this._buildConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cloudfunctions2FunctionBuildConfigList",
      },
      event_trigger: {
        value: cloudfunctions2FunctionEventTriggerToHclTerraform(this._eventTrigger.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cloudfunctions2FunctionEventTriggerList",
      },
      service_config: {
        value: cloudfunctions2FunctionServiceConfigToHclTerraform(this._serviceConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Cloudfunctions2FunctionServiceConfigList",
      },
      timeouts: {
        value: cloudfunctions2FunctionTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "Cloudfunctions2FunctionTimeouts",
      },
    };
